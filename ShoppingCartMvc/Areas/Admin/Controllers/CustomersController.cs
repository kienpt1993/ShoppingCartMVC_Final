...
namespace ShoppingCartMvc.Areas.Admin.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            int pageSize = 4; // day la so item tren 1 trang
            int pageNumber = (page ?? 1); // day la trang thu X
            var list = from s in db.Customers
                       select s;
            return View(list.ToList().ToPagedList(pageNumber, pageSize)); // return cai gi thi view tuong ung cai do
        }
